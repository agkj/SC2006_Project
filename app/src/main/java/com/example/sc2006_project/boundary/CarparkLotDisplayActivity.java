...
public class CarparkLotDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CarparkLotRecViewAdapter adapter = new CarparkLotRecViewAdapter(this, CarparkLotDisplayActivity.this);
